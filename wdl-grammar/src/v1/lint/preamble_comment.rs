...
impl<'a> PreambleComment {
        ...
        Self: Rule<&'a Pair<'a, v1::Rule>>,
    {
        lint::warning::Builder::default()
            ...
            .group(self.group())
            .subject("preamble comments without a double pound sign")
            .body(
        ...
        Self: Rule<&'a Pair<'a, v1::Rule>>,
    {
        lint::warning::Builder::default()
            ...
            .level(lint::Level::Low)
            .group(self.group())
            .subject("double pound sign are reserved for preamble comment")
            .body(
...
"#,
        ...
        assert_eq!(
            ...
            "[v1::W010::Style/Low] preamble comments without a double pound sign (1:1-1:12)"
        );
        Ok(())
    }
...
"#,
        ...
        assert_eq!(
            warnings.first().to_string(),
            "[v1::W010::Style/Low] double pound sign are reserved for preamble comment (4:1-4:19)"
        );
        Ok(())
    }
